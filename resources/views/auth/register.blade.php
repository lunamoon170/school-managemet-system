				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-lightblue">C-School</h2>
                            ...
                            <form method="POST" action="{{ route('register')}}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="name" class="form-control pl-15 bg-transparent text-white plc-white" type="text" name="name"  required autofocus autocomplete="name" />
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="email" class="form-control pl-15 bg-transparent text-white plc-white" type="email" name="email" required />
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
